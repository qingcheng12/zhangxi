...
#define GLOBALFIFO_MAJOR 255    /*预设的globalfifo的主设备号*/
...
int globalfifo_init(void)
{
  ...
  mutex_init(&globalfifo_devp->mutex);   /*初始化信号量*/
